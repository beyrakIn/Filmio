...
public class MovieCreditAdapter extends RecyclerView.Adapter<SimpleItem> {
    private Context context;
    private List<CreditMovie> movies;

    public MovieCreditAdapter(Context context, List<CreditMovie> movies) {
    ...
    public void onBindViewHolder(@NonNull SimpleItem holder, int position) {
        CreditMovie movie = movies.get(position);
    ...
    public void updateData(List<CreditMovie> movies) {
        this.movies = movies;
